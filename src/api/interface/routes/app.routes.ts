...
import { storeCompanyController,getCompany,getCompanyDetails,updateCompanyController,deleteCompany,updateCompanyStatus, updateCompanyLogo, getCompanyImages, getCompanyBySubdomainController, getCompanyLoginBanner } from "../../interface/controllers/company.controller";
...
import { getTicketListController, getTicketDetailsController, createTicketController, updateTicketController, deleteTicketController, getTicketsByUserTypeController, bulkDeleteTicketsController, exportTicketsController, importTicketsController, generateTicketRegistrationUrl, getRegistrationUrlByUserType } from "../../interface/controllers/ticket.controller";
...
export const upload = multer({ storage: storage });
    ...
    export const appRoute = (router: express.Router): void => {
        try {
            ...
            // get register URL public route
            route.get('/ticket/get-registration-url/:id', getRegistrationUrlByUserType);
            ...
            route.get("/get-company-login-banner/:subdomain", getCompanyLoginBanner);
            ...
            // event zones
            route.get("/event-zones", protectedRoute, getAllEventZonesController);
            route.get("/event-zones/:id", protectedRoute, getEventZoneByIdController);
